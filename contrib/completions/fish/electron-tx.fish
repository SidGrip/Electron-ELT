...
# Extract options
function __fish_electron_tx_get_options
...
# Extract commands
function __fish_electron_tx_get_commands
...
complete \
    --command electron-tx \
    --condition "not __fish_electron_seen_cmd (__fish_electron_tx_get_commands --commandsonly)" \
    --arguments "(__fish_electron_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command electron-tx \
    --arguments "(__fish_electron_tx_get_commands)" \
    --no-files
