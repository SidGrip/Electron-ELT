...
complete --command electron-qt --no-files

# Extract options
function __fish_electronqt_get_options
...
complete \
    --command electron-qt \
    --arguments "(__fish_electronqt_get_options --nofiles)"
