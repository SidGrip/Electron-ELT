...
const std::string CURRENCY_UNIT = "ELT"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    ELT_KVB,      //!< Use ELT/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::ELT_KVB) const;
