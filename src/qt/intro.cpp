...
bool Intro::showIfNeeded(bool& did_show_intro, int64_t& prune_MiB)
{
     ...
     * override -datadir in the electron.conf file in the default data directory
     * (to be consistent with electrond behavior)
     */
    if(dataDir != GUIUtil::getDefaultDataDirectory()) {
...
void Intro::UpdatePruneLabels(bool prune_checked)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Electron block chain.").arg(PACKAGE_NAME) + " " +
