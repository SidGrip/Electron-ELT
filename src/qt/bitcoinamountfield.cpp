...
public:
    ...
    QSize minimumSizeHint() const override
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnit::ELT, BitcoinUnits::maxMoney(), false, BitcoinUnits::SeparatorStyle::ALWAYS));
...
private:
    BitcoinUnit currentUnit{BitcoinUnit::ELT};
