...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_electron-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_electron-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_electron-qt  # macOS
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_electron-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
