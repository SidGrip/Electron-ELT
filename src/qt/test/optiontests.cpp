...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Electron/Electron-Qt.conf and all else left as default,
    // electron-qt should set both -listen and -listenonion to false and start successfully.
