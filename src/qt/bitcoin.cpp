...
static const char* qt_argv = "electron-qt";
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if(success) {
        ...
        // electron: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6-7. Parse electron.conf, determine network, switch to network specific
    ...
    // electron: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
