...
void BitcoinGUI::createActions()
{
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Electron Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Electron Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a electron: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Electron network.", "", count);
    } else {
        //: A substring of the tooltip.
