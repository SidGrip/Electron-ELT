...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BlueDragon747/Electron-ELT>";
    const std::string URL_WEBSITE = "<https://github.com/BlueDragon747/Electron-ELT>";
