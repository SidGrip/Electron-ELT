...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Electron Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Electron Core"
...
#define PACKAGE_BUGREPORT "https://github.com/BlueDragon747/Electron-ELT/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Electron Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Electron Core 0.15.21"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "electron"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/BlueDragon747/Electron-ELT"
