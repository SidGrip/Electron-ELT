...
"""Test objects for interacting with a electrond node over the p2p protocol.

The P2PInterface objects interact with the electrond nodes under test using the
...
MAGIC_BYTES = {
    "mainnet": b"\xf9\xbc\xb4\xd2",   # Electron mainnet magic.
    "testnet3": b"\x0b\x11\x09\x08",  # Electron testnet
    "regtest": b"\xfa\xbf\xb5\xda",   # Electron regtest convention.
    "signet": b"\x54\xd2\x6f\xbd",    # Electron signet (developer-only, defaults like Bitcoin)
}
