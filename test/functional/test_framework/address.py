...
ADDRESS_BCRT1_UNSPENDABLE = 'relt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqmsqlzs'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(relt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqmsqlzs)#amecmc09'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'relt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsq60p7pk'
...
# Electron regtest/mainnet use xpub/xprv version bytes with Blake Base58Check
# (inherited family Base58 identity).
...
def create_deterministic_address_bcrt1_p2tr_op_true():
    """
    Generates a deterministic Electron regtest bech32m address (segwit v1 output) that
    ...
    assert_equal(address, 'relt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqs84kxla')
