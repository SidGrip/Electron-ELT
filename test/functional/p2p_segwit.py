...
ELECTRON_REGTEST_POW_LIMIT_BITS = "207fffff"
ELECTRON_REGTEST_TARGET_SPACING = 60
...
class SegWitTest(BitcoinTestFramework):
    ...
    def build_next_block(self):
        ...
        if tip_header["bits"] != ELECTRON_REGTEST_POW_LIMIT_BITS:
            block_time = max(block_time, tip_header["time"] + 2 * ELECTRON_REGTEST_TARGET_SPACING + 1)
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older electrond's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let electrond fill it in.
