...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Electron address
            assert_raises_rpc_error(-5, "Invalid Electron address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Electron address
            assert_raises_rpc_error(-5, "Invalid Electron address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Electron address or script", self.nodes[0].importaddress, "invalid")
