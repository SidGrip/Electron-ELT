...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        # Check that startup fails if conf= is set in electron.conf or in an included conf file
    ...
    def run_test(self):
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_electron.conf")
