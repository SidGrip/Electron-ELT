...
# Copyright (c) 2026 The Electron Developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test Electron AuxPoW mining workflow and work-cache behaviour."""
...
class AuxpowMiningWorkflowTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Electron address", node0.createauxblock, "not-a-electron-address")

        self.log.info("createauxblock returns Electron-shaped work")
        start_height = node0.getblockcount()
        work0 = node0.createauxblock(address0)
        assert_equal(work0["chainid"], 7)
