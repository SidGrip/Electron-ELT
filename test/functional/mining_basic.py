...
class MiningTest(BitcoinTestFramework):
    ...
    def mine_chain(self):
        ...
        self.connect_nodes(0, 1)
        assert_equal(VERSIONBITS_TOP_BITS + ELECTRON_AUXPOW_CHAIN_ID_BITS + (1 << VERSIONBITS_DEPLOYMENT_TESTDUMMY_BIT), self.nodes[0].getblocktemplate(NORMAL_GBT_REQUEST_PARAMS)['version'])
        self.restart_node(0)
        self.connect_nodes(0, 1)
