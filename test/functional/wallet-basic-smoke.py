...
"""Basic no-send wallet smoke test for Electron Core."""
...
class WalletBasicSmokeTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 3
        # The inherited functional framework writes bitcoin.conf, so force the
        # test nodes to read the framework-generated config.
