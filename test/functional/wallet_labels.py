...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 ELT
        ...
        if self.options.descriptors:
            ...
            BECH32_INVALID = {
                '❌_VER15_PROG41': 'relt1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqajlxj8',
                '❌_VER16_PROB01': 'relt1sqq5r4036',
            }
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Electron address or script",
