...
ELECTRON_AUXPOW_CHAIN_ID_BITS = 0x00070000
VB_UNKNOWN_VERSION = VB_TOP_BITS | ELECTRON_AUXPOW_CHAIN_ID_BITS | (1 << VB_UNKNOWN_BIT)
...
class VersionBitsWarningTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because electrond will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
