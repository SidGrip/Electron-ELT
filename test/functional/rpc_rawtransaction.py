...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Electron address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 ELT/kvB
        ...
        # Fee rate is 0.20000000 ELT/kvB
