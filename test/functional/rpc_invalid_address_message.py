...
class InvalidAddressErrorMessageTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        bech32_valid = encode_segwit_address("relt", 0, bytes.fromhex("751e76e8199196d454941c45d1b3a323f1433bd6"))
        bech32_valid_caps = bech32_valid.upper()
        bech32_valid_v1 = encode_segwit_address("relt", 1, bytes.fromhex("79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798"))
        base58_valid = node.get_deterministic_priv_key().address

        bech32_invalid_prefix = bech32_valid.replace("relt1", "bc1", 1)
