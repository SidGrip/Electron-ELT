...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure electrond isn't accepting b26
        ...
        # Extend the b28 chain to make sure electrond isn't accepting b28
        ...
        # electrond doesn't disconnect us for sending a bloated block, but if we subsequently
