...
"""Test framework for Electron utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "electron-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, electron-tx
